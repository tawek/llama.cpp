...
PREFIX_MAP = {
    ...
    'mmproj': '--mmproj', 'image': '--image', 'audio': '--audio', 'video': '--video',
    'mtmd_batch_max_tokens': '--mtmd-batch-max-tokens',
    ...
    'spec_draft_backend_sampling': '--spec-draft-backend-sampling',
    ...
    'agent': '--agent', 'ui': '--ui', 'ui_config': '--ui-config', 'ui_mcp_proxy': '--ui-mcp-proxy',
    'tools': '--tools', 'embedding': '--embedding', 'rerank': '--rerank',
    'metrics': '--metrics', 'props': '--props', 'slots': '--slots',
    'log_file': '--log-file', 'log_prompts_dir': '--log-prompts-dir', 'log_colors': '--log-colors',
    ...
    'agent_no': '--no-agent',
    'spec_draft_backend_sampling_no': '--no-spec-draft-backend-sampling',
    'ui_no': '--no-ui',
    'ui_mcp_proxy_no': '--no-ui-mcp-proxy',
...
_BOOLEAN_KEYS = {
    ...
    'agent', 'spec_draft_backend_sampling', 'cont_batching', 'ui', 'ui_mcp_proxy', 'no_mmap',
    'fit', 'fit_print',
